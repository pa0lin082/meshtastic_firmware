...
// #elif defined(ESP32)
//     ADS1118(uint8_t io_pin_cs, uint8_t sclk, uint8_t miso, uint8_t mosi); ///< Constructor
//     // void begin(uint8_t sclk, uint8_t miso, uint8_t mosi);                 ///< This method initialize the SPI port and the
//     // config register
// #endif
//     double getTemperature();              ///< Getting the temperature in degrees celsius from the internal sensor of the
//     ADS1118 uint16_t getADCValue(uint8_t inputs); ///< Getting a sample from the specified input bool getADCValueNoWait(uint8_t
//     pin_drdy, uint16_t &value); bool getMilliVoltsNoWait(uint8_t pin_drdy, double &volts); ///< Getting the millivolts from the
//     settled inputs double getMilliVolts(uint8_t inputs);                      ///< Getting the millivolts from the specified
//     inputs double getMilliVolts();                                    ///< Getting the millivolts from the settled inputs void
//     decodeConfigRegister(
//         union Config configRegister);           ///< Decoding a configRegister structure and then print it out to the Serial
//         port
...
//       (SPS) ±6.144 V 		±4.096 V 	 ±2.048 V 		±1.024 V 		±0.512 V
//       ±0.256
//       V
...
//       16 (16) 32 		16 (16) 	16 (16) 	 16 (16) 		16 (16) 		16 (16)
//       16 (16) 64 		16 (16) 	16 (16) 	 16 (16) 		16 (16) 		16 (16)
//       16 (16) 128 	16 (16) 	16 (16) 	 16 (16) 		16 (16) 		16 (16) 		16
//       (15.33)
...
//             Converter with Internal Reference and Temperature Sensor", ADS1118 datasheet, SBAS457E [OCTOBER 2010–REVISED
//             OCTOBER
//       2015].
